...
const httpCors = () => {
    ...
    return (req, res, next) => {
        ...
        res.header('Access-Control-Expose-Headers', 'Content-Disposition'); //Permite que nome do arquivo seja informado na resposta de download
        ...
        const xMethod = req.method && req.method.toUpperCase && req.method.toUpperCase();
        if (xMethod === 'OPTIONS') {
            res.statusCode = 204;
