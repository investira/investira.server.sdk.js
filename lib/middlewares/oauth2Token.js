    ...
    let abstract = Object.assign(
        {
            ...
            password(pClient, pUsername, pPassword, pScope) {
                // @ts-ignore
                gLog.silly(new InternalServerError('oauth2Token middleware abstract password not implemented'));
                return Promise.reject(new InternalServerError());
            },
            ...
            refreshToken(pClient, pRefreshToken, pScope) {
                // @ts-ignore
                gLog.silly(new InternalServerError('oauth2Token middleware abstract refreshToken not implemented'));
                return Promise.reject(new InternalServerError());
            },
            ...
            authorizationCode(pClient, pCode, pRedirectURI, pBody, pAuthInfo) {
                // @ts-ignore
                gLog.silly(new InternalServerError('oauth2 middleware abstract authorizationCode not implemented'));
                return Promise.reject(new InternalServerError());
            },
            /**
             *
