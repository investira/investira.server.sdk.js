...
const oauth2 = pSource => {
    ...
    const getToken = async req => {
        ...
        gLog.silly(`oauth2 middleware ${xType}`);
    ...
    let abstract = Object.assign(
        {
            ...
            clientCredentials(pClient, pScope) {
                gLog.silly('oauth2 middleware abstract clientCredentials');
            ...
            password(pClient, pUsername, pPassword, pScope) {
                gLog.silly('oauth2 middleware abstract password');
                return Promise.resolve();
            },
            ...
            refreshToken(pClient, pRefreshToken, pScope) {
                gLog.silly('oauth2 middleware abstract refreshToken');
                return Promise.resolve();
            },
