...
const DATA_TYPES = ['date', 'datetime', 'time', 'string', 'number', 'title', 'email', 'object', 'boolean', 'encrypted'];
...
const sqls = {
    ...
    getSQLErrorClass: pErr => {
        if (pErr.info) {
            ...
            return SQLErrors[pErr.sqlState] || GeneralDataError;
        }
 ...
 * @returns {Promise}
 */
async function pvSqlWhere(pCN, pDaoMetadata, pData = {}, pOptions = {}) {
    if (isNull(pData)) {
