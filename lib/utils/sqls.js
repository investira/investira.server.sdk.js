...
// const SQLErrors = { '23000': DuplicateEntry, HY000: InvalidData };
const SQLErrors = { '23000': DuplicateEntry };
    ...
    getSqlInsert: (pCN, pDaoMetadata, pDataObject) => {
        return new Promise((pResolve, pReject) => {
            try {
                ...
                pResolve(
                    sqls.getSql(pCN, xSqlString, pvGetValues(xDataObject))
                );
            } catch (pErr) {
                pReject(pErr);
            }
        ...
        return new Promise((pResolve, pReject) => {
            try {
                ...
                let xSqlString =
                    ...
                    pvGetLimit(pLimit);
                pResolve(
                    sqls.getSql(pCN, xSqlString, pvGetValues(xConditions))
                );
            } catch (pErr) {
                pReject(pErr);
            }
