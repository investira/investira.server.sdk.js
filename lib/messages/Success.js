...
module.exports.AcceptedMessage = class AcceptedMessage extends Message {
     ...
     * Isto é uma requisição não-comprometedora, o que significa que não há nenhuma maneira no HTTP para enviar uma resposta assíncrona
     * indicando o resultado do processamento da solicitação.
