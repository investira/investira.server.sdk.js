...
class OkMessage extends MessageError {
    /**
...
class CreatedMessage extends MessageError {
    /**
...
class AcceptedMessage extends MessageError {
    /**
...
class NonAuthoritativeInformationMessage extends MessageError {
    /**
...
class NoContentMessage extends MessageError {
    /**
...
class ResetContentMessage extends MessageError {
    /**
...
class PartialContentMessage extends MessageError {
    /**
