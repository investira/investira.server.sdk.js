...
module.exports.OkMessage = class OkMessage extends MessageError {
    /**
...
module.exports.CreatedMessage = class CreatedMessage extends MessageError {
    /**
...
module.exports.AcceptedMessage = class AcceptedMessage extends MessageError {
    /**
...
module.exports.NonAuthoritativeInformationMessage = class NonAuthoritativeInformationMessage extends MessageError {
    /**
...
module.exports.NoContentMessage = class NoContentMessage extends MessageError {
    /**
...
module.exports.ResetContentMessage = class ResetContentMessage extends MessageError {
    /**
...
module.exports.PartialContentMessage = class PartialContentMessage extends MessageError {
    /**
