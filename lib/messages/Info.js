...
module.exports.ContinueMessage = class ContinueMessage extends MessageError {
    /**
...
module.exports.SwitchingProtocolMessage = class SwitchingProtocolMessage extends MessageError {
    /**
