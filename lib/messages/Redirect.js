...
class MultipleChoiceMessage extends MessageError {
    /**
...
class MovedPermanentlyMessage extends MessageError {
    /**
...
class FoundMessage extends MessageError {
    /**
...
class SeeOtherMessage extends MessageError {
    /**
...
class NotModifiedMessage extends MessageError {
    /**
...
class TemporaryRedirectMessage extends MessageError {
    /**
...
class PermanentRedirectMessage extends MessageError {
    /**
