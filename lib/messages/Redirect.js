...
module.exports.MultipleChoiceMessage = class MultipleChoiceMessage extends MessageError {
    /**
...
module.exports.MovedPermanentlyMessage = class MovedPermanentlyMessage extends MessageError {
    /**
...
module.exports.FoundMessage = class FoundMessage extends MessageError {
    /**
...
module.exports.SeeOtherMessage = class SeeOtherMessage extends MessageError {
    /**
...
module.exports.NotModifiedMessage = class NotModifiedMessage extends MessageError {
    /**
...
module.exports.TemporaryRedirectMessage = class TemporaryRedirectMessage extends MessageError {
    /**
...
module.exports.PermanentRedirectMessage = class PermanentRedirectMessage extends MessageError {
    /**
