    ...
    return Object.freeze(
        Object.assign(xDao, {
                            ...
                            if (rResult) {
                                ...
                                if (
                                    ...
                                    return sqls.getWarnings(pCN).then(rResult => {
                                        ...
                                        if (pIgnoreDuplicated && rResult[0].Code === 1062) {
                                            //Se registro já existe e foi informado para ignorar o erro
                                            return null;
                                        } else {
                                            return Promise.reject(new BadRequestError(rResult[0][0].Message));
                                        }
                                    });
                                }
                            }
            ...
            removeOne(pCN, pConditions) {
                return this.remove(pCN, pConditions, { limit: 1 });
            },
                    ...
                    return this.validate(DAO_ACTION_TYPE.MODIFY, pDataObject, pConditions).then(
                        ([rDataObjectValidated, _rConditions]) => {
                            ...
                            if (xDiff) {
                                ...
                                return this.modify(pCN, xMergedDataObject, pConditions, { limit: 1 });
                            } else {
