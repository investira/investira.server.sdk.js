// @ts-ignore
const { isNull } = require('investira.sdk').validators;
    ...
    return Object.freeze(
        Object.assign(xDao, {
                ...
                return new Promise((pResolve, pReject) => {
                    ...
                    return (
                        ...
                        this.validate(DAO_ACTION_TYPE.MODIFY, pDataObject, pConditions)
                            ...
                            //Sucesso
                            .then(rResult => {
                                if (rResult && rResult.getAffectedRowsCount() > 0) {
            ...
            modifyOne(pCN, pDataObject, pConditions, pCurrentDataObject = null) {
                ...
                if (pCurrentDataObject) {
                    // @ts-ignore
                    return this.validate(DAO_ACTION_TYPE.MODIFY, pDataObject, pConditions).then(
                        ([rDataObjectValidated, _rConditions]) => {
                            if (getDiff(pCurrentDataObject, rDataObjectValidated, true)) {
                                return this.modify(pCN, rDataObjectValidated, pConditions, 1);
                            } else {
                                return null;
                            }
                        }
