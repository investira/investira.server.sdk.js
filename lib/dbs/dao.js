        ...
        Object.freeze({
            ...
            read(pCN, pConditions, pColumns, pClauses = {}) {
                return new Promise((pResolve, pReject) => {
                    ...
                    let xRows = [];
                    return this.validate(DAO_ACTION_TYPE.READ, null, pConditions).then(([_, rConditions]) => {
                        return (
                            sqls
                                .getSqlSelect(pCN, this.metadata, rConditions, pColumns, pClauses)
                                .then(rSql => {
                                    //Executa Sql
            ...
            merge(pCN, pDataObject, pConditions, pLimit) {
                ...
                return new Promise((pResolve, pReject) => {
                    ...
                    return (
                        this.validate(DAO_ACTION_TYPE.MODIFY, pDataObject, pConditions)
                            .then(([rDataObject, rConditions]) => {
                                return this.modify(pCN, rDataObject, rConditions, pLimit);
                            })
                            .then(rRow => {
                                if (!rRow) {
