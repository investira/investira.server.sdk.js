                        ...
                        this.state.connectionPool = await mysqlx.getClient(
                            {
                                ...
                                waitTimeout: props.waitTimeout || 120,
                                mysqlxInteractiveTimeout:
                                    props.waitTimeout || 120,
                                ...
                                connectTimeout: props.connectTimeout || 500,
                            ...
                            },
                            {
                                pooling: {
                                    ...
                                    maxIdleTime: props.maxIdleTime || 500,
                                    queueTimeout: props.queueTimeout || 1000
                                }
                            }
                        );
                        gLog.info(
