...
const crud = pSource => {
    const abstract = Object.assign(
        {
            ...
            onReadOne(pCN, pConditions, pColumns) {
                return Promise.reject(
                    new NotImplementedError('crud readOne not implemented')
                );
            },
             ...
             * @param {number | object} [pClauses={}] {orderBy, limit:{page, offset, size}} Outras cláusulas da consulta
            ...
            onRead(pCN, pConditions, pColumns, pClauses) {
                return Promise.reject(
                    new NotImplementedError('crud read not implemented')
                );
            },
            //@ts-ignore
            onAdd(pCN, pDataObject) {
                return Promise.reject(
                    new NotImplementedError('acrud add not implemented')
                );
            },
            //@ts-ignore
            onRemoveOne(pCN, pConditions) {
                return Promise.reject(
                    new NotImplementedError('crud removeone not implemented')
                );
            },
            //@ts-ignore
            onRemove(pCN, pConditions, pLimit) {
                return Promise.reject(
                    new NotImplementedError('rcrud remove not implemented')
                );
            },
            //@ts-ignore
            onModify(pCN, pDataObject, pConditions, pLimit) {
                return Promise.reject(
                    new NotImplementedError('crud modify not implementedd')
                );
            },
            //@ts-ignore
            onMerge(pCN, pDataObject, pConditions, pLimit) {
                return Promise.reject(
                    new NotImplementedError('crud merge not implemented')
                );
            }
        },
        pSource
    ...
    return Object.assign(
        ...
        Object.freeze({
            ...
            read(pCN, pConditions, pColumns, pLimit) {
                try {
                    return abstract.onRead(pCN, pConditions, pColumns, pLimit);
                } catch (pErr) {
                    gLog.error(pErr);
                    return Promise.reject(pErr);
                }
            ...
            add(pCN, pDataObject) {
                try {
                    ...
                    return this.validate(
                        CRUD_ACTION_TYPE.ADD,
                        pDataObject,
                        null
                    ).then(rDataObject => {
                        return abstract.onAdd(pCN, rDataObject);
                    });
                } catch (pErr) {
                    gLog.error(pErr);
                    return Promise.reject(pErr);
            ...
            remove(pCN, pConditions, pLimit) {
                try {
                    ...
                    return this.validate(
                        ...
                        return abstract.onRemove(pCN, pConditions, pLimit);
                    });
                } catch (pErr) {
                    gLog.error(pErr);
                    return Promise.reject(pErr);
            ...
            modify(pCN, pDataObject, pConditions, pLimit) {
                try {
                    //Valida os dados e recebe novo objeto com os dados já validados
                    return this.validate(
                        CRUD_ACTION_TYPE.MODIFY,
                        pDataObject,
                        pConditions
                    ).then(rDataObject => {
                        return abstract.onModify(
                            pCN,
                            rDataObject,
                            pConditions,
                            pLimit
            ...
            merge(pCN, pDataObject, pConditions, pLimit) {
                try {
                    //Valida os dados e recebe novo objeto com os dados já validados
                    return this.validate(
                        CRUD_ACTION_TYPE.MERGE,
                        pDataObject,
                        pConditions
                    ).then(rDataObject => {
                        return abstract.onMerge(
                            pCN,
                            rDataObject,
                            pConditions,
                            pLimit
    ...
    //  * @returns Promise com os novos dados já validados
    //  */
    // const validate = (pTYPE, pDataObject, pConditions = null) => {
    //     try {
    //         let pAction = {
    //             TYPE: pTYPE,
    //             isEditing: (2 & pTYPE) == 2,
    //             isRemoving: (32 & pTYPE) == 32
    //         };
    //         return abstract.onValidate(pAction, pDataObject, pConditions);
    //     } catch (pErr) {
    //         gLog.error(pErr);
    //         return Promise.reject(pErr);
    //     }
    ...
    //  * @returns Promise com a informação do than
    //  */
    // const readOne = (pCN, pConditions, pColumns) => {
    //     try {
    //         return abstract.onReadOne(pCN, pConditions, pColumns);
    //     } catch (pErr) {
    //         gLog.error(pErr);
    ...
    //  * @returns Promise com os dados lidos ou null quando não existir
    //  */
    // const read = (pCN, pConditions, pColumns, pLimit) => {
    //     try {
    //         return abstract.onRead(pCN, pConditions, pColumns, pLimit);
    //     } catch (pErr) {
    //         gLog.error(pErr);
    ...
    //  * @returns Promise com os dados incluídos, inclusive com a autoincremento/sequence, se existir
    //  */
    // const add = (pCN, pDataObject) => {
    //     try {
    //         //Valida os dados e recebe novo objeto com os dados já validados
    //         return validate(TYPE.ADD, pDataObject, null).then(rDataObject => {
    //             return abstract.onAdd(pCN, rDataObject);
    //         });
    //     } catch (pErr) {
    //         gLog.error(pErr);
    ...
    //  * @returns Promise com a quantidade de registro excluídos
    //  */
    // const removeOne = (pCN, pConditions) => {
    //     try {
    //         //Valida os dados e recebe novo objeto com os dados já validados
    //         return validate(TYPE.REMOVE, null, pConditions).then(() => {
    //             return abstract.onRemoveOne(pCN, pConditions);
    //         });
    //     } catch (pErr) {
    //         gLog.error(pErr);
    ...
    //  * @returns Promise com a quantidade de registro excluídos
    //  */
    // const remove = (pCN, pConditions, pLimit) => {
    //     try {
    //         //Valida os dados e recebe novo objeto com os dados já validados
    //         return validate(TYPE.REMOVE, null, pConditions).then(() => {
    //             return abstract.onRemove(pCN, pConditions, pLimit);
    ...
    //  * @returns Promise com os dados alterados ou null se nehum registro foi encontrado para edição
    //  */
    // const modify = (pCN, pDataObject, pConditions, pLimit) => {
    //     try {
    //         //Valida os dados e recebe novo objeto com os dados já validados
    //         return validate(TYPE.MODIFY, pDataObject, pConditions).then(
    //             rDataObject => {
    //                 return abstract.onModify(
    //                     pCN,
    //                     rDataObject,
    ...
    //  * @returns Promise com os dados alterados/incluídos
    //  */
    // const merge = (pCN, pDataObject, pConditions, pLimit) => {
    //     try {
    //         //Valida os dados e recebe novo objeto com os dados já validados
    //         return validate(TYPE.MERGE, pDataObject, pConditions).then(
    //             rDataObject => {
    //                 return abstract.onMerge(
    //                     pCN,
    //                     rDataObject,
